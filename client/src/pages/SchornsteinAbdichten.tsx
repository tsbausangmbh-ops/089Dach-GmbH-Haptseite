...
export default function SchornsteinAbdichten() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      ...
      <Navigation />
      <AIBeraterSection 
        pageName="Schornstein abdichten"
        description="Wie wird ein Schornstein abgedichtet? Unser KI-Berater erklärt Materialien und Kosten."
      />
      ...
      <section className="relative py-20 text-white overflow-hidden min-h-[60vh] flex items-center">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-white/90 mb-4 max-w-7xl mx-auto">Undichte Kamineinfassung? Wir dichten Ihren Schornstein dauerhaft ab.</p>
            <p className="text-lg text-white/70 mb-8">Ab 250€ • Schnelle Hilfe • Meisterbetrieb</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button asChild size="lg" className="bg-red-600 hover:bg-red-700 text-white text-lg px-8 py-6" data-testid="button-hero-callback"><a href="/rueckruf/"><Phone className="mr-2 h-5 w-5" />Rückruf anfordern</a></Button>
      ...
      <section className="py-6 bg-red-600 text-white">
        <div className="container mx-auto px-4">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button asChild size="lg" className="bg-white text-red-700 hover:bg-red-50 text-lg px-8" data-testid="button-cta-callback"><a href="/rueckruf/">Rückruf anfordern<ArrowRight className="ml-2 h-5 w-5" /></a></Button>
