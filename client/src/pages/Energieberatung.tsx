...
export default function Energieberatung() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <SEO 
        title="Energieberatung Dach München – Dämmung & Fördermittel"
        description="Energieberatung fürs Dach in München: Dämmung optimieren, Heizkosten senken & Fördermittel nutzen. Individuelle Beratung vom Meisterbetrieb."
        canonical="https://089dach.de/leistungen/energieberatung"
        keywords="Energieberatung Dach München, Dämmung optimieren München, Heizkosten senken Dach, Fördermittel Dämmung München"
