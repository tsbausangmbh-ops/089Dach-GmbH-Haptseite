...
const stadtteilData = {
  ...
  fullName: "München Milbertshofen-Am Hart",
  plz: "80807, 80809, 80937, 80939",
  entfernung: "5 km",
  beschreibung: "Milbertshofen-Am Hart im Münchner Norden ist geprägt durch das BMW-Werk und wachsende Wohnviertel. Die Mischung aus Industrie, Gewerbe und Wohnbebauung bietet vielfältige Dachprojekte – von Gewerbehallen bis zu Mehrfamilienhäusern.",
  besonderheiten: [
    "Heimat des BMW-Werks",
    "Wachsendes Wohnviertel",
...
function NearbyServiceSchema() {
  const schema = {
    ...
    "@type": "Service",
    "@id": `https://089dach.de/dachdecker-milbertshofen/#service`,
    ...
    "serviceType": ["Flachdach", "Dachsanierung", "Dachrinnenreinigung", "Sturmschaden-Reparatur", "Wasserschaden-Sanierung", "Dachreparatur"]
  };
  return (<script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(schema) }} />);
}

export default function StadtteilMilbertshofen() {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-8">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {[
                    { title: "Dachrinnenreinigung", desc: "Professionelle Rinnenreinigung in Milbertshofen" },
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gray-50 rounded-xl p-4 md:p-6">
                ...
                <ul className="space-y-3">
                  {["Meisterbetrieb seit 1998", "Schnelle Anfahrt", "10 Jahre Garantie", "Gewerbe-Erfahrung", "Über 200 Projekte"].map((item, idx) => (
