...
const stadtteile = [
  ...
  { name: "Aubing-Lochhausen", entfernung: "7 km", link: "/dachdecker-aubing-lochhausen-langwied" },
  { name: "Westend", entfernung: "6 km", link: "/dachdecker-westend" },
  { name: "Schwanthalerhöhe", entfernung: "5 km", link: "/dachdecker-schwanthalerhoehe" },
  { name: "Maxvorstadt", entfernung: "7 km", link: "/dachdecker-maxvorstadt" },
  { name: "Altstadt", entfernung: "8 km", link: "/dachdecker-altstadt" },
  { name: "Lehel", entfernung: "9 km", link: "/dachdecker-lehel" },
  { name: "Isarvorstadt", entfernung: "7 km", link: "/dachdecker-ludwigsvorstadt-isarvorstadt" },
  { name: "Schwabing", entfernung: "8 km", link: "/dachdecker-schwabing" },
  { name: "Sendling", entfernung: "7 km", link: "/dachdecker-sendling" },
  { name: "Sendling-Westpark", entfernung: "6 km", link: "/dachdecker-sendling-westpark" },
  { name: "Thalkirchen", entfernung: "8 km", link: "/dachdecker-thalkirchen" },
  { name: "Bogenhausen", entfernung: "10 km", link: "/dachdecker-bogenhausen" },
  { name: "Oberföhring", entfernung: "12 km", link: "/dachdecker-oberfoehring" },
  { name: "Harlaching", entfernung: "9 km", link: "/dachdecker-harlaching" },
  { name: "Trudering", entfernung: "14 km", link: "/dachdecker-trudering" },
  { name: "Berg am Laim", entfernung: "11 km", link: "/dachdecker-berg-am-laim" },
  ...
  { name: "Freimann", entfernung: "10 km", link: "/dachdecker-freimann" },
  { name: "Hasenbergl", entfernung: "12 km", link: "/dachdecker-hasenbergl" },
    ...
    <div className="min-h-screen bg-background font-sans">
      ...
      <section className="py-3 md:py-4">
        <div className="container mx-auto px-4 md:px-6 lg:px-12">
          ...
          <h2 className="text-2xl md:text-3xl font-heading font-bold text-secondary mb-6 md:mb-8">Umland (20 km Radius)</h2>
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 mb-12">
          ...
          <div className="bg-primary/5 rounded-xl p-4 md:p-8 border border-primary/20">
            <h3 className="text-xl md:text-2xl font-heading font-bold text-secondary mb-4">Warum 089Dach für Ihr Viertel?</h3>
