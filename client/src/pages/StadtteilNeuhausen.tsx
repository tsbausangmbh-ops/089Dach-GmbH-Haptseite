...
const stadtteilData = {
  ...
  plz: "80634, 80636, 80637, 80639",
  entfernung: "4 km",
  beschreibung: "Neuhausen-Nymphenburg gehört zu den beliebtesten Wohnvierteln Münchens. Der lebendige Stadtteil besticht durch seine Altbausubstanz, gründerzeitliche Fassaden und einen einzigartigen Mix aus historischen Villen und modernen Wohnanlagen.",
  besonderheiten: [
    "Historische Altbauten aus der Gründerzeit",
    "Denkmalgeschützte Fassaden",
    "Beliebtes Familienviertel",
    "Nähe zum Nymphenburger Schloss"
  ],
  typischeProjekte: [
...
function NearbyServiceSchema() {
  const schema = {
    ...
    "description": `Professionelle Dachdeckerarbeiten in ${stadtteilData.fullName}. Altbau-Experten mit Denkmalschutz-Erfahrung.`,
    "provider": {
    ...
    "serviceType": ["Dachsanierung", "Altbau", "Denkmalschutz", "Dachgeschossausbau"]
  };
  return (<script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(schema) }} />);
}

export default function StadtteilNeuhausen() {
  return (
    <div className="min-h-screen bg-background font-sans">
      <SEO 
        title={`Dachdecker Neuhausen | Altbau-Experten München ⭐ 4.9/5`}
        description={`Dachdecker in München-Neuhausen ✓ Altbausanierung ✓ Denkmalschutz ✓ Dachgeschossausbau ✓ 10 Jahre Garantie. Tel: 089 12621964`}
        canonical={`https://089dach.de/dachdecker-neuhausen`}
        keywords={`dachdecker neuhausen, dachsanierung neuhausen münchen, altbau dachdecker münchen, dachgeschossausbau neuhausen, dachreparatur neuhausen`}
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {[
                    ...
                    { title: "Zinkblechdach", desc: "Für historische Villen" },
