  ...
  return (
    <div className="min-h-screen bg-background font-sans">
      <SEO 
        ...
        keywords={`dachsanierung kosten münchen, dach erneuern kosten pro qm, dachdecker preise münchen 2025, dachsanierung preis pro qm bayern, dach neu eindecken kosten einfamilienhaus, was kostet neue dacheindeckung, dachziegel austauschen kosten, dachreparatur kosten münchen, komplettsanierung dach preis, dachsanierung förderung kosten, gerüst kosten dachsanierung, entsorgung alte dachziegel kosten, dachsanierung angebot vergleichen, dachsanierung finanzieren kredit, dachsanierung steuer absetzen wie, dachsanierung 150 qm kosten, dachsanierung doppelhaushälfte preis, dachsanierung bungalow kosten, dachsanierung mehrfamilienhaus preis, dachdecker stundenlohn münchen 2025, handwerkerkosten dach angemessen, dachsanierung kostenvoranschlag einholen, dachsanierung budget planen`}
