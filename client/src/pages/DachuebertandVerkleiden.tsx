  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button asChild size="lg" className="bg-purple-600 hover:bg-purple-700 text-white text-lg px-8 py-6" data-testid="button-hero-callback"><a href="/rueckruf/"><Phone className="mr-2 h-5 w-5" />Kostenloses Angebot</a></Button>
      ...
      <section className="py-6 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-3xl font-bold text-center text-slate-800 mb-12"><strong>Dachüberstand verkleiden</strong> – Materialien & Preise</h2>
      ...
      <section className="py-6 bg-purple-600 text-white">
        <div className="container mx-auto px-4">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button asChild size="lg" className="bg-white text-purple-700 hover:bg-purple-50 text-lg px-8" data-testid="button-cta-callback"><a href="/rueckruf/">Angebot anfordern<ArrowRight className="ml-2 h-5 w-5" /></a></Button>
      ...
      <section className="py-6 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-7xl mx-auto">
            <ServiceGeoLinks currentService="Dachüberstand" />
          </div>
        </div>
      </section>
      ...
      <LeadFunnel 
        headline="Dachüberstand verkleiden in München?"
        subheadline="Wir gestalten Ihre Dachuntersicht."
        description="Dachüberstand verkleiden – saubere Dachuntersicht für Schutz und Optik."
      />
