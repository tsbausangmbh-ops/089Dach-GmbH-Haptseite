...
const stadtteilData = {
  name: "Freimann",
  slug: "freimann",
  fullName: "München-Freimann",
  plz: "80939, 80807",
  entfernung: "10 km",
  beschreibung: "Freimann im Münchner Norden verbindet gewerbliche Gebiete mit Wohnvierteln und liegt nahe der Allianz Arena. Die Bausubstanz reicht von Einfamilienhäusern bis zu modernen Wohnanlagen.",
  besonderheiten: [
    "Nähe zur Allianz Arena und BMW Welt",
    "Mix aus Wohn- und Gewerbegebieten",
    "Moderne Neubauviertel entstehen"
  ],
  typischeProjekte: [
    "Steildach-Sanierung",
    "Flachdach Gewerbe",
  ...
  referenzProjekte: [
    {
      ...
      beschreibung: "Dachsanierung mit Vorbereitung für Photovoltaikanlage und neuer Wärmedämmung.",
      jahr: "2024"
    },
    {
      titel: "Gewerbegebäude Euro-Industriepark",
...
function NearbyServiceSchema() {
  const schema = {
    ...
    "description": `Professionelle Dachdeckerarbeiten in ${stadtteilData.fullName}. Wohn- und Gewerbegebäude.`,
    "provider": {
    ...
    "serviceType": ["Dachsanierung", "Flachdach", "Solar-Vorbereitung", "Dachrinnenreinigung", "Sturmschaden-Reparatur", "Wasserschaden-Sanierung", "Dachreparatur"]
  };
  return (<script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(schema) }} />);
}

export default function StadtteilFreimann() {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-8">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {[
                    { title: "Dachrinnenreinigung", desc: "Professionelle Rinnenreinigung in Freimann", img: imgDachrinnenreinigung },
            ...
            <div className="space-y-6">
              <div className="bg-primary text-white rounded-xl p-4 md:p-6">
                ...
                <p className="text-white/90 mb-6">Unverbindliche Beratung vor Ort.</p>
