...
const stadtteilData = {
  name: "Westend",
  fullName: "München-Westend",
  plz: "80339, 80336",
  entfernung: "6 km",
  beschreibung: "Das Westend ist ein lebendiges, multikulturelles Viertel mit einer Mischung aus Altbauten, Gewerbegebäuden und neuen Wohnanlagen. Die Nähe zur Theresienwiese und zum Hauptbahnhof macht es zu einem dynamischen Stadtteil.",
  besonderheiten: [
    "Mix aus Altbau und modernen Wohnanlagen",
    "Gewerbegebäude und Wohnhäuser",
    "Gentrifizierung mit steigenden Ansprüchen"
  ],
  typischeProjekte: [
...
function NearbyServiceSchema() {
  const schema = {
    ...
    "description": `Professionelle Dachdeckerarbeiten in ${stadtteilData.fullName}. Spezialist für Altbau und Gewerbe.`,
    "provider": {
    ...
    "serviceType": ["Dachsanierung", "Flachdach", "Dachausbau", "Gauben", "Dachrinnenreinigung", "Sturmschaden-Reparatur", "Wasserschaden-Sanierung", "Dachreparatur"]
  };
  return (<script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(schema) }} />);
}

export default function StadtteilWestend() {
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-12 relative z-10">
          <div className="max-w-5xl text-white">
            <div className="flex items-center gap-2 mb-3 md:mb-4">
              ...
              <span className="text-primary font-bold tracking-wider uppercase text-sm">Altbau & Gewerbe</span>
            </div>
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-heading font-bold text-white mb-4 md:mb-6">
              <strong>Dachdecker {stadtteilData.fullName}</strong>
            </h1>
            <p className="text-lg md:text-xl text-gray-200 max-w-xl mb-4 md:mb-6">
              Ihr <strong>Dachdecker-Meisterbetrieb</strong> – spezialisiert auf Altbauten und Gewerbegebäude im <strong>{stadtteilData.name}</strong> in <strong>München</strong>.
            </p>
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-8">
              <div>
                <h2 className="text-2xl md:text-3xl font-heading font-bold text-secondary mb-4">089Dach GmbH – Ihr lokaler <strong>Dachdecker</strong> im {stadtteilData.name}</h2>
                <p className="text-lg text-muted-foreground leading-relaxed mb-4"><TextWithKeywordLinks currentPath="/dachdecker-westend">{stadtteilData.beschreibung}</TextWithKeywordLinks></p>
                <p className="text-lg text-muted-foreground leading-relaxed">
                  Als <strong>Meisterbetrieb</strong> aus <strong>München</strong> haben wir die Erfahrung für alle Dachtypen im <strong>Westend</strong>. 
                  Ob <strong>Dachsanierung</strong>, <strong>Dachreparatur</strong> oder <strong>Notdienst</strong> – flexible Terminplanung für minimale Störung.
                </p>
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {[
                    { title: "Dachrinnenreinigung", desc: "Professionelle Rinnenreinigung in Westend" },
              ...
              <div className="bg-secondary/5 rounded-xl p-4 md:p-6">
                ...
                <p className="text-muted-foreground mb-2"><TextWithKeywordLinks currentPath="/dachdecker-westend">{stadtteilData.referenzProjekt.beschreibung}</TextWithKeywordLinks></p>
            ...
            <div className="space-y-6">
              <div className="bg-primary text-white rounded-xl p-4 md:p-6">
                ...
                <p className="text-white/90 mb-6">Für Privat und Gewerbe.</p>
              ...
              <div className="bg-gray-50 rounded-xl p-4 md:p-6">
                ...
                <ul className="space-y-3">
                  {["Meisterbetrieb seit 1998", "Privat & Gewerbe", "10 Jahre Garantie", "Flexible Termine", "Festpreise"].map((item, idx) => (
