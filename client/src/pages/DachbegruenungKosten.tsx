...
export default function DachbegruenungKosten() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      ...
      <Navigation />
      <AIBeraterSection 
        pageName="Dachbegrünung Kosten"
        description="Was kostet Dachbegrünung? Unser KI-Berater erklärt Kosten und Förderung."
      />
      ...
      <section className="relative py-20 text-white overflow-hidden min-h-[60vh] flex items-center">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6"><strong>Dachbegrünung Kosten</strong> München</h1>
            <p className="text-xl md:text-2xl text-white/90 mb-4 max-w-7xl mx-auto"><strong>Grünes Dach</strong> für besseres Klima – <strong>extensive</strong> oder <strong>intensive Begrünung</strong> für Ihr Flachdach.</p>
            <p className="text-lg text-white/70 mb-8">Ab <strong>40€/m²</strong> • <strong>Förderung</strong> möglich • Meisterbetrieb</p>
      ...
      <section className="py-6 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-3xl font-bold text-center text-slate-800 mb-12"><strong>Dachbegrünung</strong> – Begrünungsarten & Preise</h2>
      ...
      <section className="py-6 bg-green-600 text-white">
        <div className="container mx-auto px-4">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button asChild size="lg" className="bg-white text-green-700 hover:bg-green-50 text-lg px-8" data-testid="button-cta-callback"><a href="/rueckruf/">Beratung anfordern<ArrowRight className="ml-2 h-5 w-5" /></a></Button>
      ...
      <LeadFunnel 
        headline="Dachbegrünung Kosten in München?"
        subheadline="Wir beraten zu Kosten und Förderung."
        description="Transparente Dachbegrünung Kosten – inklusive bis zu 50€/m² Förderung vom Freistaat."
      />
