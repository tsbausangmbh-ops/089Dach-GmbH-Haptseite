...
import SEO, { BreadcrumbSchema, ServiceSchema, ProductServiceSchema, LocalBusinessSchema, FAQPageSchema } from "@/components/SEO";
import heroImage from "@assets/generated_images/bright_attic_room_after_skylights.webp";
import darkAttic from "@assets/generated_images/dark_attic_before_window_installation.webp";
import brightAttic from "@assets/generated_images/bright_attic_room_after_skylights.webp";
import roofWindow from "@assets/generated_images/modern_roof_window_installation.webp";
import damagedDormer from "@assets/generated_images/damaged_dormer_window_before.webp";
    ...
    <div className="min-h-screen bg-white">
            ...
            <div className="grid md:grid-cols-2 gap-4 items-center" data-testid="testimonial-berger">
              <div>
                ...
                <h2 className="text-3xl font-heading font-bold mb-4">
                  <strong>Dachfenster einbauen München</strong> – Vorher dunkel, nachher lichtdurchflutet
                </h2>
      ...
      <section className="py-5 bg-secondary text-white">
        <div className="container mx-auto px-6 lg:px-12 text-center">
          <h2 className="text-3xl font-heading font-bold mb-4">
            <strong>Dachfenster Kosten & Förderung</strong> – Häufige Fragen
          </h2>
