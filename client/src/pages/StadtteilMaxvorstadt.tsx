...
const stadtteilData = {
  ...
  entfernung: "7 km",
  beschreibung: "Die Maxvorstadt ist das kulturelle Herz Münchens mit zahlreichen Museen, Universitäten und gründerzeitlichen Wohnbauten. Die historische Bausubstanz erfordert erfahrene Dachdecker mit Gespür für Denkmalschutz.",
  besonderheiten: [
    "Gründerzeitliche Altbauten und Jugendstil",
    "Universitätsgebäude und Kulturbauten",
...
function NearbyServiceSchema() {
  const schema = {
    ...
    "description": `Professionelle Dachdeckerarbeiten in ${stadtteilData.fullName}. Spezialist für Altbau und Denkmalschutz.`,
    "provider": {
...
export default function StadtteilMaxvorstadt() {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-secondary/5 rounded-xl p-4 md:p-6">
                ...
                <p className="text-muted-foreground mb-2"><TextWithKeywordLinks currentPath="/dachdecker-maxvorstadt">{stadtteilData.referenzProjekt.beschreibung}</TextWithKeywordLinks></p>
