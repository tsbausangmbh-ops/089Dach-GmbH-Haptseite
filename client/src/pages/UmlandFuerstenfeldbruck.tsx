...
const stadtteilData = {
  ...
  fullName: "Fürstenfeldbruck",
  plz: "82256",
  entfernung: "25 km",
  beschreibung: "Fürstenfeldbruck, die Kreisstadt westlich von München, verbindet historischen Charme mit modernem Wohnen. Das barocke Kloster Fürstenfeld und die historische Altstadt prägen das Stadtbild. Viele Einfamilienhäuser und Reihenhäuser in den Wohngebieten bieten vielfältige Dachprojekte.",
  besonderheiten: [
    "Historische Kreisstadt mit Kloster",
...
function NearbyServiceSchema() {
  const schema = {
    ...
    "@type": "Service",
    "@id": `https://089dach.de/dachdecker-fuerstenfeldbruck/#service`,
  ...
  return (
    <div className="min-h-screen bg-background font-sans">
      <SEO 
        ...
        keywords={`dachdecker fürstenfeldbruck, dachsanierung ffb, dachdecker landkreis fürstenfeldbruck, denkmalschutz ffb, dachdämmung fürstenfeldbruck, altstadt ffb dach, sturmschaden dach ffb, dachziegel wechseln ffb, dachdecker 82256, dachfenster fürstenfeldbruck, biberschwanz ffb, was kostet dachdecker fürstenfeldbruck, dachdecker fürstenfeldbruck erfahrungen, guter dachdecker fürstenfeldbruck, bester dachdecker fürstenfeldbruck bei münchen, dach undicht fürstenfeldbruck, dach reparieren fürstenfeldbruck, notdienst dachdecker fürstenfeldbruck, dachdecker fürstenfeldbruck preise, dachdecker fürstenfeldbruck kosten, dachdecker fürstenfeldbruck günstig, dachdecker fürstenfeldbruck festpreis, dachdecker in der nähe fürstenfeldbruck, dachdeckerbetrieb fürstenfeldbruck`}
        geoPlacename={`Fürstenfeldbruck, Landkreis Fürstenfeldbruck, Bayern, Deutschland`}
      />
      <BreadcrumbSchema items={[{ name: "Home", url: "/" }, { name: "Umland", url: "/umland" }, { name: `Dachdecker ${stadtteilData.name}`, url: `/dachdecker-fuerstenfeldbruck` }]} />
      <NearbyServiceSchema />
      <Navbar />
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-12 relative z-10">
          <div className="max-w-5xl text-white">
            ...
            <p className="text-lg md:text-xl text-gray-200 max-w-xl mb-4 md:mb-6">
              Ihr Dachdecker-Meisterbetrieb für {stadtteilData.name} und den Landkreis FFB.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-8">
              <div>
                ...
                <p className="text-lg text-muted-foreground leading-relaxed mb-4"><TextWithKeywordLinks currentPath="/dachdecker-fuerstenfeldbruck">{stadtteilData.beschreibung}</TextWithKeywordLinks></p>
                <p className="text-lg text-muted-foreground leading-relaxed">
                  Als Münchner Meisterbetrieb sind wir regelmäßig im Landkreis Fürstenfeldbruck tätig.
                </p>
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {[
                    ...
                    { title: "Ziegeleindeckung", desc: "Klassisch" },
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gray-50 rounded-xl p-4 md:p-6">
                ...
                <ul className="space-y-3">
                  {["Meisterbetrieb seit 1998", "Regelmäßig im LK FFB", "10 Jahre Garantie", "Festpreisgarantie", "Über 200 Projekte"].map((item, idx) => (
