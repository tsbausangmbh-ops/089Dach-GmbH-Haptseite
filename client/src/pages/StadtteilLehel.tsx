...
const stadtteilData = {
  ...
  plz: "80538, 80539",
  entfernung: "9 km",
  beschreibung: "Das Lehel ist eines der ältesten und vornehmsten Viertel Münchens. Geprägt von herrschaftlichen Villen, Gründerzeitbauten und der Nähe zur Isar, erfordern die Dächer hier höchste handwerkliche Qualität.",
  besonderheiten: [
    "Herrschaftliche Villen und Palais",
    "Exklusive Wohnlage mit hohen Ansprüchen",
    "Historische Bausubstanz aus dem 19. Jahrhundert"
  ],
  typischeProjekte: [
    "Villa-Dachsanierung",
    "Kupferdacharbeiten",
...
function NearbyServiceSchema() {
  const schema = {
    ...
    "description": `Professionelle Dachdeckerarbeiten in ${stadtteilData.fullName}. Spezialist für Villen und historische Bauten.`,
    "provider": {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-secondary/5 rounded-xl p-4 md:p-6">
                ...
                <p className="text-muted-foreground mb-2"><TextWithKeywordLinks currentPath="/dachdecker-lehel">{stadtteilData.referenzProjekt.beschreibung}</TextWithKeywordLinks></p>
            ...
            <div className="space-y-6">
              <div className="bg-primary text-white rounded-xl p-4 md:p-6">
                ...
                <p className="text-white/90 mb-6">Spezialisierte Beratung für exklusive Immobilien.</p>
              ...
              <div className="bg-gray-50 rounded-xl p-4 md:p-6">
                ...
                <ul className="space-y-3">
                  {["Meisterbetrieb seit 1998", "Erfahrung mit Villen", "10 Jahre Garantie", "Eigene Spenglerwerkstatt", "Premium-Materialien"].map((item, idx) => (
