...
export default function SatteldachKosten() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      ...
      <Navigation />
      <AIBeraterSection 
        pageName="Satteldach Kosten"
        description="Was kostet ein Satteldach? Unser KI-Berater nennt Preise pro qm."
      />
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button asChild size="lg" className="bg-emerald-600 hover:bg-emerald-700 text-white text-lg px-8 py-6" data-testid="button-hero-callback"><a href="/rueckruf/"><Phone className="mr-2 h-5 w-5" />Kostenlose Beratung</a></Button>
      ...
      <section className="py-6 bg-emerald-600 text-white">
        <div className="container mx-auto px-4">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button asChild size="lg" className="bg-white text-emerald-700 hover:bg-emerald-50 text-lg px-8" data-testid="button-cta-callback"><a href="/rueckruf/">Beratung anfordern<ArrowRight className="ml-2 h-5 w-5" /></a></Button>
