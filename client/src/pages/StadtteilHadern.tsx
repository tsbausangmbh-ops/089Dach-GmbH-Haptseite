...
function NearbyServiceSchema() {
  const schema = {
    ...
    "serviceType": ["Dachsanierung", "Flachdach", "Dachdämmung", "Garagendach"]
  };
  ...
  return (
    <div className="min-h-screen bg-background font-sans">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-8">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {[
                    { title: "Flachdach", desc: "Sanierung und Neueindeckung" },
                    { title: "Steildach", desc: "Ziegel und Betondachsteine" },
                    { title: "Dachdämmung", desc: "Energetische Sanierung" },
                    { title: "Garagendach", desc: "Abdichtung und Begrünung" },
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gray-50 rounded-xl p-4 md:p-6">
                ...
                <ul className="space-y-3">
                  {["Meisterbetrieb seit 1998", "Kurze Anfahrt (5 km)", "10 Jahre Garantie", "Festpreisangebote", "Lokale Referenzen"].map((item, idx) => (
      ...
      <RelatedServices 
        ...
        relatedIds={["stadtteile", "referenzen", "flachdach", "faq"]}
      />
      <Contact />
      <Footer />
    </div>
