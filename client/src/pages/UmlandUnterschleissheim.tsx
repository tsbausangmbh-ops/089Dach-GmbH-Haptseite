...
const stadtteilData = {
  ...
  fullName: "Unterschleißheim bei München",
  plz: "85716",
  entfernung: "15 km",
  beschreibung: "Unterschleißheim im Münchner Norden ist eine moderne Stadt mit hervorragender S-Bahn-Anbindung. Die Mischung aus Einfamilienhäusern, Reihenhäusern und Gewerbeflächen bietet vielfältige Dachprojekte. Als direkte Nachbargemeinde sind wir schnell vor Ort.",
  besonderheiten: [
    "Moderne Stadt im Münchner Norden",
    "Hervorragende S-Bahn-Anbindung",
    "Viele Einfamilien- und Reihenhäuser",
    "Kurze Anfahrt aus München"
  ],
  typischeProjekte: [
...
function NearbyServiceSchema() {
  const schema = {
    ...
    "@type": "Service",
    "@id": `https://089dach.de/dachdecker-unterschleissheim/#service`,
...
export default function UmlandUnterschleissheim() {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-8">
              <div>
                ...
                <p className="text-lg text-muted-foreground leading-relaxed mb-4"><TextWithKeywordLinks currentPath="/dachdecker-unterschleissheim">{stadtteilData.beschreibung}</TextWithKeywordLinks></p>
                <p className="text-lg text-muted-foreground leading-relaxed">
                  Die kurze Entfernung zu unserem Standort ermöglicht schnelle Reaktionszeiten – auch bei Notfällen.
                </p>
              </div>
              ...
              <div className="bg-secondary/5 rounded-xl p-4 md:p-6">
                ...
                <p className="text-muted-foreground mb-2"><TextWithKeywordLinks currentPath="/dachdecker-unterschleissheim">{stadtteilData.referenzProjekt.beschreibung}</TextWithKeywordLinks></p>
