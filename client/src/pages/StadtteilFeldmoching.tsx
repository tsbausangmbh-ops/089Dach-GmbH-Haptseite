...
const stadtteilData = {
  ...
  plz: "80933, 80995",
  entfernung: "7 km",
  beschreibung: "Feldmoching-Hasenbergl ist einer der größten Stadtbezirke Münchens mit einer vielfältigen Bebauung. Von historischen Bauernhöfen über Einfamilienhäuser bis zu Mehrfamilienhäusern – wir sind der richtige Partner für alle Dachprojekte im Münchner Norden.",
  besonderheiten: [
    "Größter Stadtbezirk im Münchner Norden",
    "Vielfältige Bebauung: Einfamilienhaus bis Mehrfamilienhaus",
    "Historische Gebäude und Bauernhöfe",
  ...
  referenzProjekte: [
    {
      ...
      beschreibung: "Komplettsanierung des Flachdachs eines 24-Parteien-Hauses mit moderner Abdichtung und Wärmedämmung.",
      jahr: "2024"
    },
    {
      titel: "Einfamilienhaus Am Feldmochinger See",
...
function NearbyServiceSchema() {
  const schema = {
    ...
    "description": `Professionelle Dachdeckerarbeiten in ${stadtteilData.fullName}. Für alle Gebäudetypen.`,
    "provider": {
...
export default function StadtteilFeldmoching() {
  ...
  return (
    <div className="min-h-screen bg-background font-sans">
      <SEO 
        title="Dachdecker Feldmoching – Sanierung, Reparatur & Notdienst"
        description="Ihr Dachdecker in Feldmoching: Dachsanierung, Reparatur, Flachdach, Spengler, Dachfenster. 24/7 Notdienst, Festpreis & 10 Jahre Garantie. Jetzt anrufen!"
        canonical=""
        keywords="Dachdecker Feldmoching, Dachsanierung Feldmoching, Dachreparatur Feldmoching, Flachdach Feldmoching, Spengler Feldmoching, Dach Notdienst Feldmoching, Dachfenster Feldmoching"
      />
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {[
                    { title: "Dachrinnenreinigung", desc: "Professionelle Rinnenreinigung in Feldmoching", img: imgDachrinnenreinigung },
      ...
      <LeadFunnel 
        ...
        description="Ihr Dachdecker für Feldmoching – Meisterbetrieb mit schneller Hilfe."
      />
      <DecisionPressureBanner />
      <Contact 
        title="Dachdecker in Feldmoching gesucht?"
        description="Wir sind Ihr lokaler Dachdecker-Meisterbetrieb in Feldmoching."
      />
      <Footer />
    </div>
  );
