...
import rinnenImg1 from "@assets/generated_images/copper_roof_gutter_detail.webp";
import rinnenImg2 from "@assets/generated_images/bogenhausen_chimney_old_flashing.webp";
import rinnenImg3 from "@assets/generated_images/bogenhausen_chimney_new_copper.webp";
import rinnenImg4 from "@assets/generated_images/new_copper_chimney_flashing.webp";
...
export default function Dachrinnenreinigung() {
  return (
    <div className="min-h-screen bg-background font-sans">
      <SEO 
        title="Dachrinnenreinigung München – Reinigung & Austausch"
        description="Dachrinnenreinigung München: Reinigung, Reparatur & Austausch. Verstopfungen vorbeugen & Wasserschäden vermeiden. Jetzt Termin sichern."
        canonical="https://089dach.de/leistungen/dachrinnenreinigung"
        keywords="Dachrinnenreinigung München, Dachrinnen Reparatur München, Dachrinnen Austausch München, Dachrinnen Wartung"
