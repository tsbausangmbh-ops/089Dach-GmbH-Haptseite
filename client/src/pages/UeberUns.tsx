...
import portraitGF from "@assets/generated_images/german_businessman_portrait_gf.webp";
import portraitMeister from "@assets/generated_images/german_master_roofer_portrait.webp";
import heroImage from "@assets/generated_images/roofing_team_partnership_handshake.webp";
    ...
    <div className="min-h-screen bg-background font-sans">
      ...
      <section id="geschichte" className="py-4 md:py-4 bg-white">
        <div className="container mx-auto px-6 lg:px-12">
          ...
          <div className="bg-secondary/5 rounded-xl p-8 md:p-12 border border-secondary/10 max-w-7xl mx-auto">
