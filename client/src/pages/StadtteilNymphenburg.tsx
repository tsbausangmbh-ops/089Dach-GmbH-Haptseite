...
const stadtteilData = {
  ...
  plz: "80638, 80639, 80797",
  entfernung: "6 km",
  beschreibung: "Nymphenburg ist geprägt von historischen Altbauten, prächtigen Villen und dem berühmten Schloss. Die Mischung aus denkmalgeschützten Gebäuden und gehobenen Wohnlagen erfordert Dachdecker mit Erfahrung in traditioneller Handwerkskunst.",
  besonderheiten: [
    "Historische Altbauten und Gründerzeitvillen",
    "Nähe zum Schloss Nymphenburg",
    "Viele denkmalgeschützte Gebäude",
    "Exklusive Wohnlagen mit hohen Standards"
  ],
  typischeProjekte: [
    "Altbau-Dachsanierung",
    "Biberschwanz-Eindeckungen",
...
function NearbyServiceSchema() {
  const schema = {
    ...
    "description": `Professionelle Dachdeckerarbeiten in ${stadtteilData.fullName}. Spezialist für Altbauten und Denkmalschutz.`,
    "provider": {
...
export default function StadtteilNymphenburg() {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-secondary/5 rounded-xl p-4 md:p-6">
                ...
                <p className="text-muted-foreground mb-2"><TextWithKeywordLinks currentPath="/dachdecker-nymphenburg">{stadtteilData.referenzProjekt.beschreibung}</TextWithKeywordLinks></p>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gray-50 rounded-xl p-4 md:p-6">
                ...
                <ul className="space-y-3">
                  {["Meisterbetrieb seit 1998", "Über 200 Projekte in München", "10 Jahre Garantie", "Altbau-Erfahrung", "Denkmalschutz-Kompetenz"].map((item, idx) => (
