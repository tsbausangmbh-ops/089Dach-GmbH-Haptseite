...
const stadtteilData = {
  ...
  plz: "81245, 81247",
  entfernung: "5 km",
  beschreibung: "Obermenzing ist eines der exklusivsten Wohnviertel Münchens. Die großzügigen Villengrundstücke, historischen Landhäuser und repräsentativen Einfamilienhäuser prägen diesen grünen Stadtteil im Münchner Westen.",
  besonderheiten: [
    "Exklusive Villenviertel",
    "Historische Landhäuser",
    "Großzügige Grundstücke",
    "Nähe zu Schloss Blutenburg"
  ],
  typischeProjekte: [
    "Dachsanierung Villa",
    "Schiefereindeckung",
...
function NearbyServiceSchema() {
  const schema = {
    ...
    "description": `Professionelle Dachdeckerarbeiten in ${stadtteilData.fullName}. Spezialist für exklusive Villen.`,
    "provider": {
...
export default function StadtteilObermenzing() {
  return (
    <div className="min-h-screen bg-background font-sans">
      <SEO 
        title={`Dachdecker Obermenzing | Villen-Experten München ⭐ 4.9/5`}
        description={`Dachdecker in München-Obermenzing ✓ Villen ✓ Schiefer ✓ Kupferdach ✓ Premium-Qualität ✓ 10 Jahre Garantie. Tel: 089 12621964`}
        canonical={`https://089dach.de/dachdecker-obermenzing`}
        keywords={`dachdecker obermenzing, dachsanierung obermenzing münchen, villa dachdecker münchen, schieferdach obermenzing, kupferdach münchen`}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="space-y-6">
              <div className="bg-primary text-white rounded-xl p-4 md:p-6">
                ...
                <p className="text-white/90 mb-6">Individuelle Beratung für Ihr exklusives Projekt.</p>
              ...
              <div className="bg-gray-50 rounded-xl p-4 md:p-6">
                ...
                <ul className="space-y-3">
                  {["Meisterbetrieb seit 1998", "Premium-Qualität", "10 Jahre Garantie", "Villen-Experten", "Individuelle Beratung"].map((item, idx) => (
