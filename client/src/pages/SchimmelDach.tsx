...
export default function SchimmelDach() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      ...
      <section className="relative py-20 bg-gradient-to-br from-purple-700 via-purple-800 to-slate-900 text-white overflow-hidden">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a href="tel:+498912621964">
                <Button size="lg" variant="outline" className="border-purple-600 text-purple-600 hover:bg-purple-50 text-lg px-8" data-testid="button-cta-call">
                  <Phone className="mr-2 h-5 w-5" />
                  089 12621964
                </Button>
              </a>
      ...
      <LeadFunnel />
      <RelatedServices currentPage="schimmel" />
      <Footer />
    </div>
  );
}
