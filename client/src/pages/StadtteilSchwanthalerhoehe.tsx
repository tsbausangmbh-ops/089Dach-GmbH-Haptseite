...
const stadtteilData = {
  ...
  plz: "80339, 80336",
  entfernung: "5 km",
  beschreibung: "Die Schwanthalerhöhe liegt zentral nahe der Theresienwiese und verbindet historische Bausubstanz mit modernen Wohnanlagen. Das Viertel bietet eine vielfältige Dachlandschaft von Altbau bis Neubau.",
  besonderheiten: [
    "Nähe zur Theresienwiese und Messe",
...
function NearbyServiceSchema() {
  const schema = {
    ...
    "description": `Professionelle Dachdeckerarbeiten in ${stadtteilData.fullName}. Altbau bis Neubau.`,
    "provider": {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gray-50 rounded-xl p-4 md:p-6">
                ...
                <ul className="space-y-3">
                  {["Meisterbetrieb seit 1998", "Kurze Anfahrtswege", "10 Jahre Garantie", "Eigene Spenglerwerkstatt", "Hochwertige Materialien"].map((item, idx) => (
