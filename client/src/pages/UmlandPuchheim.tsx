...
const stadtteilData = {
  ...
  nachbarStadtteile: ["Germering", "Gröbenzell", "Eichenau", "Aubing"]
};
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-8">
              <div>
                ...
                <p className="text-lg text-muted-foreground leading-relaxed mb-4"><TextWithKeywordLinks currentPath="/dachdecker-puchheim">{stadtteilData.beschreibung}</TextWithKeywordLinks></p>
              </div>
