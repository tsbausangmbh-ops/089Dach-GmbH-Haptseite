...
export default function Heizkostenrechner() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <SEO 
        title="Heizkostenrechner Dach – Einsparpotenzial berechnen"
        description="Heizkostenrechner Dach: Berechnen Sie Ihr Einsparpotenzial durch Dämmung & Sanierung. Inklusive persönlicher Beratung & Förderinformationen."
        canonical="https://089dach.de/heizkostenrechner"
        keywords="Heizkostenrechner Dach, Dämmung Einsparrechner, Dachsanierung Kostenrechner, Energiesparrechner Dach"
