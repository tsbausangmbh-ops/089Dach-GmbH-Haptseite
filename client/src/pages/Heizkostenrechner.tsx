  ...
  return (
    <div className="min-h-screen bg-white">
      <SEO 
        ...
        keywords="heizkosten rechner münchen, energiekosten berechnen dachdämmung sparen, energieeinsparung dach heizkosten senken förderung, rechner obermenzing pasing laim schwabing sendling bogenhausen, rechner gräfelfing planegg germering starnberg dachau, sparpotenzial berechnen online kostenlos, wie viel spart dachdämmung wirklich, heizkosten altbau senken, energieverbrauch haus berechnen, wärmeverlust über dach prozent, amortisation dachdämmung berechnen, co2 einsparung durch dämmung, heizkosten vor nach sanierung vergleich, energiekosten einfamilienhaus durchschnitt"
        ...
        <div className="container mx-auto px-6 lg:px-12">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="text-lg text-muted-foreground max-w-7xl mx-auto mb-4">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-green-50/50 border border-green-100 p-5 rounded-lg shadow-sm text-center">
                ...
                <h3 className="font-bold text-green-700 mb-2">Kostenlos & unverbindlich</h3>
              ...
              <div className="bg-green-50/50 border border-green-100 p-5 rounded-lg shadow-sm text-center">
                ...
                <h3 className="font-bold text-green-700 mb-2">Basierend auf echten Daten</h3>
                <p className="text-sm text-green-600">
              ...
              <div className="bg-green-50/50 border border-green-100 p-5 rounded-lg shadow-sm text-center">
                ...
                <h3 className="font-bold text-green-700 mb-2">Konkrete Ersparnis sehen</h3>
                <p className="text-sm text-green-600">
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8 items-stretch">
              <div className="bg-gray-50 p-8 rounded-xl h-full flex flex-col">
                ...
                <div className="space-y-5 flex-1 flex flex-col">
                  ...
                  <Button 
                    ...
                    className="w-full bg-primary hover:bg-primary/90 text-white font-bold py-6 text-lg mt-auto"
              ...
              <div className="h-full">
                {result ? (
                  <div className="bg-gradient-to-br from-primary/10 to-primary/5 p-8 rounded-xl border border-primary/20 h-full flex flex-col">
                  ...
                  <div className="bg-gradient-to-br from-stone-50 to-stone-100 p-8 rounded-xl h-full flex flex-col">
            ...
            <div className="mt-12 bg-stone-50 p-8 rounded-xl">
              ...
              <div className="mt-8 text-center">
                <Link href="/daemmung-info">
                  <Button className="bg-red-600 hover:bg-red-700 text-white font-bold px-8 py-6 rounded-xl" data-testid="link-daemmung-ratgeber">
