...
export default function DachbodenAusbauen() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      ...
      <Navigation />
      <AIBeraterSection 
        pageName="Dachboden ausbauen"
        description="Genehmigung, Dämmung, Kosten? Unser KI-Berater beantwortet Ihre Fragen zum Dachausbau."
      />
      ...
      <section className="relative py-20 text-white overflow-hidden min-h-[60vh] flex items-center">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-white/90 mb-4 max-w-7xl mx-auto">Aus ungenutztem Dachboden wird wertvoller Wohnraum – Dämmung, Fenster, Ausbau.</p>
            <p className="text-lg text-white/70 mb-8">800-1.500€/m² komplett • KfW-förderfähig • Meisterbetrieb</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button asChild size="lg" className="bg-violet-600 hover:bg-violet-700 text-white text-lg px-8 py-6" data-testid="button-hero-callback"><a href="/rueckruf/"><Phone className="mr-2 h-5 w-5" />Kostenlose Beratung</a></Button>
      ...
      <section className="py-6 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-3xl font-bold text-center text-slate-800 mb-12"><strong>Dachboden ausbauen</strong> – Leistungen & Preise</h2>
      ...
      <section className="py-6 bg-violet-600 text-white">
        <div className="container mx-auto px-4">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button asChild size="lg" className="bg-white text-violet-700 hover:bg-violet-50 text-lg px-8" data-testid="button-cta-callback"><a href="/rueckruf/">Beratung anfordern<ArrowRight className="ml-2 h-5 w-5" /></a></Button>
