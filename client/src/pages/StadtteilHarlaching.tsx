...
const stadtteilData = {
  name: "Harlaching",
  fullName: "München-Harlaching",
  plz: "81545, 81547",
  entfernung: "10 km",
  beschreibung: "Harlaching gehört zu den grünsten und ruhigsten Wohngebieten Münchens. Die großzügigen Einfamilienhäuser und Villen mit ihren gepflegten Gärten erfordern Dachdecker, die mit höchster Sorgfalt und Qualitätsbewusstsein arbeiten.",
  besonderheiten: [
    "Großzügige Einfamilienhäuser und Villen",
    "Gehobene Wohngegend mit hohen Standards",
    "Viel Grün und ruhige Lage",
    "Steildächer mit klassischen Ziegeleindeckungen"
  ],
  typischeProjekte: [
    "Dachsanierung Einfamilienhaus",
    "Ziegeleindeckung mit Engobe",
  ...
  referenzProjekte: [
    {
      ...
      beschreibung: "Komplettsanierung eines Steildachs mit Premium-Tondachziegeln, vollflächiger Aufsparrendämmung und neuen VELUX-Dachfenstern.",
      jahr: "2024"
    },
    {
      titel: "Villa Harlaching",
...
function NearbyServiceSchema() {
  const schema = {
    ...
    "@type": "Service",
    "@id": `https://089dach.de/dachdecker-harlaching/#service`,
    "name": `Dachdecker ${stadtteilData.fullName}`,
    "description": `Professionelle Dachdeckerarbeiten in ${stadtteilData.fullName}. Spezialist für Einfamilienhäuser und Villen.`,
    "provider": {
...
export default function StadtteilHarlaching() {
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {[
                    { title: "Dachrinnenreinigung", desc: "Professionelle Rinnenreinigung in Harlaching", img: imgDachrinnenreinigung },
