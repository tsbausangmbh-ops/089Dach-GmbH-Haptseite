...
export default function DachdeckerPreise() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      <SEO 
        title="Dachdecker Preise München 2025 | Preisliste | 089Dach"
        description="Dachdecker Preise München: ✓ Reparatur ab 80€ ✓ Neueindeckung 60-180€/m² ✓ Dachrinne 30-80€/lfm ✓ Transparente Preisliste ✓ Festpreisgarantie!"
        canonical="/dachdecker-preise"
        keywords="dachdecker preise, dachdecker kosten, dachdecker stundenlohn, dachdecker preisliste, was kostet dachdecker, dachdecker kosten pro stunde, dachdecker münchen preise, dachdeckerarbeiten preise, dachdecker angebot"
        aiSummary="Dachdecker Preise in München 2025: Stundensatz 55-75€, Reparatur ab 80€, Neueindeckung 60-180€/m². 089Dach GmbH arbeitet mit Festpreisen und bietet kostenlose Beratung. Tel: 089 12621964."
      />
      ...
      <section className="relative py-20 text-white overflow-hidden min-h-[60vh] flex items-center">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">Dachdecker Preise München</h1>
            <p className="text-xl md:text-2xl text-white/90 mb-4 max-w-3xl mx-auto">Transparente Preise für alle Dachdeckerarbeiten – von der kleinen Reparatur bis zur Komplettsanierung.</p>
            <p className="text-lg text-white/70 mb-8">Festpreisgarantie • Keine versteckten Kosten • Kostenlose Beratung</p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a href="tel:+498912621964"><Button size="lg" variant="outline" className="border-blue-600 text-blue-600 hover:bg-blue-50 text-lg px-8" data-testid="button-cta-call"><Phone className="mr-2 h-5 w-5" />089 12621964</Button></a>
            </div>
          </div>
        </div>
      </section>
