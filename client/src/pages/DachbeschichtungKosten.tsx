...
export default function DachbeschichtungKosten() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      <SEO 
        title="Dachbeschichtung Kosten München | 30-50€/m² | Wie neu!"
        description="Dachbeschichtung München: ✓ Reinigung + Beschichtung 30-50€/m² ✓ Viele Farben ✓ 10-15 Jahre länger ✓ Meisterbetrieb. Jetzt beraten lassen!"
        canonical="/dachbeschichtung-kosten"
        keywords="dachbeschichtung kosten, dachbeschichtung preis, dach beschichten kosten, dachfarbe kosten, dachziegel beschichten, dachbeschichtung münchen, dachversiegelung kosten"
        aiSummary="Dachbeschichtung Kosten München: Komplett 30-50€/m², Premium 40-60€/m². Verlängert Lebensdauer um 10-15 Jahre. 089Dach. Tel: 089 12621964."
      />
