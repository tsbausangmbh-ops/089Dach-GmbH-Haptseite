        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="tel:+498912621964"><Button size="lg" className="bg-red-600 hover:bg-red-700 text-white text-lg px-8 py-6" data-testid="button-hero-call"><Phone className="mr-2 h-5 w-5" />Jetzt anrufen: 089 12621964</Button></a>
      ...
      <section className="py-16 bg-red-600 text-white">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="tel:+498912621964"><Button size="lg" className="bg-white text-red-600 hover:bg-red-50 text-lg px-8" data-testid="button-cta-call"><Phone className="mr-2 h-5 w-5" />089 12621964</Button></a>
