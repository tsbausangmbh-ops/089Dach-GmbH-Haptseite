...
const stadtteilData = {
  name: "Olching",
  fullName: "Olching bei München",
  plz: "82140",
  entfernung: "16 km",
  beschreibung: "Olching ist eine Stadt im Landkreis Fürstenfeldbruck mit attraktiven Wohnlagen. Die gute Anbindung über die A8 und S-Bahn ermöglicht schnelle Anfahrten von unserem Standort.",
  besonderheiten: [
    "Attraktive Wohnstadt im Münchner Westen",
    "Gute Anbindung über A8 und S-Bahn",
  ...
  nachbarStadtteile: ["Gröbenzell", "Fürstenfeldbruck", "Maisach", "Esting"]
};
