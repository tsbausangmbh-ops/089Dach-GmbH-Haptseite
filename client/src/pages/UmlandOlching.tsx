...
const stadtteilData = {
  ...
  nachbarStadtteile: ["Gröbenzell", "Puchheim", "Fürstenfeldbruck", "Maisach"]
};
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-12 relative z-10">
          <div className="max-w-5xl text-white">
            ...
            <p className="text-lg md:text-xl text-gray-200 max-w-xl mb-4 md:mb-6">
              Ihr <strong>Dachdecker-Meisterbetrieb</strong> für {stadtteilData.name} – schnell über die A8 bei Ihnen.
            </p>
