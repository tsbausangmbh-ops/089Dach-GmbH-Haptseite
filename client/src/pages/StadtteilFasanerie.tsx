...
const stadtteilData = {
  name: "Fasanerie",
  fullName: "München-Fasanerie",
  plz: "80995, 80996",
  entfernung: "5 km",
  beschreibung: "Die Fasanerie ist ein ruhiges Wohnviertel im Münchner Norden mit vielen Einfamilienhäusern und Reihenhäusern. Die gewachsene Siedlungsstruktur und die Nähe zu unserem Standort machen uns zum idealen Partner für alle Dacharbeiten in der Fasanerie.",
  besonderheiten: [
    "Ruhiges Wohnviertel mit Familiencharakter",
    "Viele Einfamilienhäuser und Reihenhäuser",
    "Gewachsene Siedlungsstruktur",
    "Gute Erreichbarkeit, kurze Anfahrt"
  ],
  typischeProjekte: [
  ...
  referenzProjekte: [
    {
      ...
      beschreibung: "Dachsanierung mit Aufsparrendämmung und neuen VELUX-Dachfenstern für eine junge Familie.",
      jahr: "2024"
    },
    {
      titel: "Einfamilienhaus Lerchenauer Straße",
...
export default function StadtteilFasanerie() {
  ...
  return (
    <div className="min-h-screen bg-background font-sans">
      <SEO 
        title="Dachdecker Fasanerie – Sanierung, Reparatur & Notdienst"
        description="Ihr Dachdecker in Fasanerie: Dachsanierung, Reparatur, Flachdach, Spengler, Dachfenster. 24/7 Notdienst, Festpreis & 10 Jahre Garantie. Jetzt anrufen!"
        canonical=""
        keywords="Dachdecker Fasanerie, Dachsanierung Fasanerie, Dachreparatur Fasanerie, Flachdach Fasanerie, Spengler Fasanerie, Dach Notdienst Fasanerie, Dachfenster Fasanerie"
      />
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-8">
              <div>
                <h2 className="text-2xl md:text-3xl font-heading font-bold text-secondary mb-4">089Dach GmbH – Ihr <strong>Dachdecker</strong> für die {stadtteilData.name}</h2>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {[
                    { title: "Dachrinnenreinigung", desc: "Professionelle Rinnenreinigung in der Fasanerie", img: imgDachrinnenreinigung },
      ...
      <LeadFunnel 
        ...
        subheadline="Wir sind Ihr Partner in Fasanerie."
        description="Ihr Dachdecker für Fasanerie – Meisterbetrieb mit schneller Hilfe."
      />
      <DecisionPressureBanner />
      <Contact 
        title="Dachdecker in Fasanerie gesucht?"
        description="Wir sind Ihr lokaler Dachdecker-Meisterbetrieb in Fasanerie."
      />
      <Footer />
    </div>
  );
