...
const stadtteilData = {
  ...
  entfernung: "3 km",
  beschreibung: "Laim verbindet urbanes Leben mit ruhigen Wohnvierteln. Von Gründerzeitbauten bis zu modernen Reihenhäusern findet man hier vielfältige Dachkonstruktionen, die regelmäßige Pflege benötigen.",
  besonderheiten: [
    "Mischung aus historischen Altbauten und Neubauten",
    "Viele Mehrfamilienhäuser mit Flachdächern",
    "Zentrale Lage mit guter Erreichbarkeit"
  ],
  typischeProjekte: [
    "Flachdachabdichtung Mehrfamilienhaus",
    "Dachsanierung Gründerzeitbau",
...
export default function StadtteilLaim() {
  return (
      ...
      <div className="bg-stone-100 py-2 md:py-3 border-b border-stone-200">
        <div className="container mx-auto px-4 md:px-6 lg:px-12">
          <div className="flex flex-wrap justify-center gap-3 md:gap-6 text-xs md:text-sm">
            ...
            <span className="flex items-center gap-2"><Clock className="h-4 w-4 text-primary" />Anfahrt: ~12 Min</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-secondary/5 rounded-xl p-4 md:p-6">
                ...
                <p className="text-muted-foreground mb-2"><TextWithKeywordLinks currentPath="/dachdecker-laim">{stadtteilData.referenzProjekt.beschreibung}</TextWithKeywordLinks></p>
