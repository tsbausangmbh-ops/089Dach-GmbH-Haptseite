...
export default function SchneefanggitterMontage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      ...
      <Navigation />
      <AIBeraterSection 
        pageName="Schneefanggitter"
        description="Wann sind Schneefanggitter Pflicht? Unser KI-Berater erklärt die Regelungen."
      />
      ...
      <section className="relative py-20 text-white overflow-hidden min-h-[60vh] flex items-center">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6"><strong>Schneefanggitter Montage</strong> München</h1>
            <p className="text-xl md:text-2xl text-white/90 mb-4 max-w-7xl mx-auto">Schneefang ist in Bayern Pflicht – wir montieren alle Systeme fachgerecht.</p>
            <p className="text-lg text-white/70 mb-8">Ab 25€/lfm • Pflicht in Bayern • Meisterbetrieb</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button asChild size="lg" className="bg-sky-600 hover:bg-sky-700 text-white text-lg px-8 py-6" data-testid="button-hero-callback"><a href="/rueckruf/"><Phone className="mr-2 h-5 w-5" />Kostenloses Angebot</a></Button>
      ...
      <section className="py-6 bg-sky-600 text-white">
        <div className="container mx-auto px-4">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button asChild size="lg" className="bg-white text-sky-700 hover:bg-sky-50 text-lg px-8" data-testid="button-cta-callback"><a href="/rueckruf/">Angebot anfordern<ArrowRight className="ml-2 h-5 w-5" /></a></Button>
