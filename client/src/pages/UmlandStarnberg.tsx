...
const stadtteilData = {
  name: "Starnberg",
  fullName: "Starnberg am See",
  plz: "82319",
  entfernung: "25 km",
  beschreibung: "Starnberg am Starnberger See ist eine der exklusivsten Wohnlagen im Münchner Umland. Die Villen am See, historischen Landhäuser und repräsentativen Anwesen erfordern höchste handwerkliche Qualität und Premium-Materialien.",
  besonderheiten: [
    "Exklusive Seelage am Starnberger See",
    "Premium-Villen und Landhäuser",
...
function NearbyServiceSchema() {
  const schema = {
    ...
    "description": `Premium-Dachdeckerarbeiten in ${stadtteilData.fullName}. Spezialist für exklusive Villen.`,
    "provider": {
    ...
    "serviceType": ["Dachsanierung", "Schiefer", "Kupferdach", "Denkmalschutz"]
  };
  return (<script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(schema) }} />);
}

export default function UmlandStarnberg() {
      ...
      <div className="bg-stone-100 py-2 md:py-3 border-b border-stone-200">
        <div className="container mx-auto px-4 md:px-6 lg:px-12">
          <div className="flex flex-wrap justify-center gap-3 md:gap-6 text-xs md:text-sm">
            ...
            <span className="flex items-center gap-2"><Clock className="h-4 w-4 text-primary" />Anfahrt: ~35 Min</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-8">
              <div>
                ...
                <p className="text-lg text-muted-foreground leading-relaxed">
                  Für anspruchsvolle Bauherren am Starnberger See bieten wir Premium-Materialien wie Naturschiefer, Kupfer und handgestrichene Ziegel.
                </p>
              </div>
              ...
              <div className="bg-primary/5 rounded-xl p-4 md:p-6 border border-primary/20">
                <h3 className="text-xl font-heading font-bold text-secondary mb-4 flex items-center gap-2">
                  <Award className="h-6 w-6 text-primary" />089Dach GmbH kennt die Besonderheiten in <strong>{stadtteilData.name}</strong>
                </h3>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {[
                    ...
                    { title: "Dachfenster", desc: "Premium-Linie" },
            ...
            <div className="space-y-6">
              <div className="bg-primary text-white rounded-xl p-4 md:p-6">
                ...
                <p className="text-white/90 mb-6">Individuelle Beratung für Ihr exklusives Projekt am See.</p>
              ...
              <div className="bg-gray-50 rounded-xl p-4 md:p-6">
                ...
                <ul className="space-y-3">
                  {["Meisterbetrieb seit 1998", "Premium-Qualität", "10 Jahre Garantie", "Villen-Experten", "Individuelle Betreuung"].map((item, idx) => (
