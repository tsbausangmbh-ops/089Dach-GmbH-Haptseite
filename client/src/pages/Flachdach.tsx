...
import flachdachImg1 from "@assets/generated_images/flat_roof_bitumen_detail_with_texture.webp";
import flachdachImg2 from "@assets/generated_images/flat_green_roof_with_natural_variations.webp";
import flachdachImg3 from "@assets/generated_images/realistic_damaged_flat_roof_before.webp";
import flachdachImg4 from "@assets/generated_images/realistic_garage_epdm_roof_after.webp";
    ...
    <div className="min-h-screen bg-background font-sans">
      ...
      <section className="pt-6 pb-8 md:pt-10 md:pb-12 bg-secondary relative overflow-hidden min-h-[35vh] flex items-center">
        <div className="absolute inset-0 z-0">
          <img
            src={flachdachImg1}
            alt="Flachdach abdichten München - Professionelle Flachdachsanierung"
