  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      <SEO 
        ...
        keywords="dachentmoosung kosten, dach moos entfernen, dachreinigung münchen, dach entmoosen lassen, moos auf dach entfernen, dachziegel reinigen, dachentmoosung preis, was kostet dachentmoosung münchen, dachentmoosung münchen erfahrungen, wie lange dauert dachentmoosung, dachentmoosung selber machen oder profi, dachentmoosung kosten pro qm, dachentmoosung münchen günstig, dachentmoosung festpreis münchen, dachentmoosung preisvergleich, dachentmoosung meisterbetrieb münchen, dachentmoosung fachbetrieb münchen, dachentmoosung handwerker münchen"
      ...
      <Navigation />
      <AIBeraterSection 
        pageName="Dachentmoosung"
        description="Ist Dachentmoosung sinnvoll? Unser KI-Berater erklärt Vor- und Nachteile."
      />
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button asChild size="lg" className="bg-green-600 hover:bg-green-700 text-white text-lg px-8 py-6" data-testid="button-hero-callback"><a href="/rueckruf/"><Phone className="mr-2 h-5 w-5" />Kostenloses Angebot</a></Button>
      ...
      <section className="py-6 bg-green-600 text-white">
        <div className="container mx-auto px-4">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button asChild size="lg" className="bg-white text-green-700 hover:bg-green-50 text-lg px-8" data-testid="button-cta-callback"><a href="/rueckruf/">Angebot anfordern<ArrowRight className="ml-2 h-5 w-5" /></a></Button>
