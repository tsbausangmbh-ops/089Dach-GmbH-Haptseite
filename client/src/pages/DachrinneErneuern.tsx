...
export default function DachrinneErneuern() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      ...
      <Navigation />
      <AIBeraterSection 
        pageName="Dachrinne erneuern"
        description="Zink, Kupfer oder Kunststoff? Unser KI-Berater berät zu Materialien und Kosten."
      />
      ...
      <section className="relative py-20 text-white overflow-hidden min-h-[60vh] flex items-center">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-white/90 mb-4 max-w-7xl mx-auto">Zink, Kupfer, Alu oder Kunststoff – wir erneuern Ihre Dachrinne fachgerecht und schnell.</p>
      ...
      <section className="py-6 bg-blue-600 text-white">
        <div className="container mx-auto px-4">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button asChild size="lg" className="bg-white text-blue-700 hover:bg-blue-50 text-lg px-8" data-testid="button-cta-callback"><a href="/rueckruf/">Angebot anfordern<ArrowRight className="ml-2 h-5 w-5" /></a></Button>
