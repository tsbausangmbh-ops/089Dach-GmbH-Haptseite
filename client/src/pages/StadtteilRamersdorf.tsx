...
const stadtteilData = {
  ...
  fullName: "München-Ramersdorf-Perlach",
  plz: "81735, 81737, 81739, 81549",
  entfernung: "8 km",
  beschreibung: "Ramersdorf-Perlach ist einer der bevölkerungsreichsten Stadtbezirke Münchens. Die Mischung aus historischem Ortskern, Siedlungshäusern der Nachkriegszeit und modernen Wohnanlagen bietet vielfältige Dachprojekte – von der Sanierung bis zum Flachdach.",
  besonderheiten: [
    "Einer der größten Münchner Stadtbezirke",
    "Historischer Ortskern Ramersdorf",
    "Viele Siedlungshäuser und Reihenhäuser",
    "Moderne Wohnanlagen in Neuperlach"
  ],
  typischeProjekte: [
    "Dachsanierung Siedlungshaus",
    "Flachdach-Sanierung Mehrfamilienhaus",
...
function NearbyServiceSchema() {
  const schema = {
    ...
    "@type": "Service",
    "@id": `https://089dach.de/dachdecker-ramersdorf-perlach/#service`,
