  ...
  return (
    <div className="min-h-screen bg-background font-sans">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-8">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {[
                    { title: "Dachrinnenreinigung", desc: "Professionelle Rinnenreinigung in Giesing" },
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gray-50 rounded-xl p-4 md:p-6">
                ...
                <ul className="space-y-3">
                  {["Meisterbetrieb seit 1998", "Altbau-Experten", "10 Jahre Garantie", "Dachausbau-Spezialisten", "Über 200 Projekte"].map((item, idx) => (
      ...
      <RelatedServices 
        ...
        relatedIds={["stadtteile", "referenzen", "gaubenbau", "dachsanierung"]}
      />
      <Contact />
      <Footer />
    </div>
