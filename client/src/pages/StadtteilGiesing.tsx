...
function NearbyServiceSchema() {
  const schema = {
    ...
    "serviceType": ["Dachsanierung", "Altbau", "Dachgeschossausbau", "Flachdach"]
  };
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {[
                    ...
                    { title: "Dachgeschossausbau", desc: "Neuer Wohnraum" },
                    { title: "Flachdach", desc: "Abdichtung und Sanierung" },
                    { title: "Dachdämmung", desc: "Energieeffizient" },
                    { title: "Dachfenster", desc: "Mehr Licht im Dachgeschoss" },
