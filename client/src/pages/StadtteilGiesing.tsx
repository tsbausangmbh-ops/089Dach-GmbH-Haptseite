...
import imgSturmschaden from "@assets/generated_images/damaged_roof_with_missing_tiles.webp";
import imgWasserschaden from "@assets/generated_images/leaking_roof_with_water_damage.webp";
import imgDachUndicht from "@assets/generated_images/leaking_roof_gutter_dripping.webp";
import imgDachsanierung from "@assets/generated_images/roofers_installing_battens_and_tiles.webp";
import imgDachreparatur from "@assets/generated_images/roofer_doing_quick_repairs.webp";
import imgReferenz2 from "@assets/generated_images/anthracite_roof_with_velux_cabrio.webp";
...
const stadtteilData = {
  name: "Giesing",
  fullName: "München-Giesing",
  plz: "81539, 81541, 81543, 81547",
  entfernung: "8 km",
  beschreibung: "Giesing ist ein traditionsreiches Münchner Arbeiterviertel, das sich zu einem beliebten Wohnstandort entwickelt hat. Die Mischung aus historischen Arbeitersiedlungen, Altbauten und Neubauprojekten bietet vielfältige Dachprojekte – von der Sanierung bis zum Dachgeschossausbau.",
  besonderheiten: [
    "Traditionsreiches Arbeiterviertel",
    "Historische Siedlungsbauten",
    "Beliebtes Wohnviertel mit Altbauten",
    "Viele Dachgeschoss-Ausbauprojekte"
  ],
  typischeProjekte: [
  ...
  referenzProjekte: [
    {
      ...
      beschreibung: "Komplettsanierung eines denkmalgeschützten Mehrfamilienhauses mit neuer Ziegeleindeckung und Dachgeschossausbau für zwei Wohneinheiten.",
      jahr: "2024"
    },
    {
      titel: "Reihenhaus Untergiesing",
...
function NearbyServiceSchema() {
  const schema = {
    ...
    "description": `Professionelle Dachdeckerarbeiten in ${stadtteilData.fullName}. Altbau-Experten und Dachgeschossausbau.`,
    "provider": {
    ...
    "serviceType": ["Dachsanierung", "Altbau", "Dachgeschossausbau", "Dachrinnenreinigung", "Sturmschaden-Reparatur", "Wasserschaden-Sanierung", "Dachreparatur"]
  };
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-12 relative z-10">
          <div className="max-w-5xl text-white">
            <div className="flex items-center gap-2 mb-3 md:mb-4">
              ...
              <span className="text-primary font-bold tracking-wider uppercase text-sm">Altbau & Dachausbau</span>
            </div>
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-heading font-bold text-white mb-4 md:mb-6">
              <strong>Dachdecker {stadtteilData.fullName}</strong>
            </h1>
            <p className="text-lg md:text-xl text-gray-200 max-w-xl mb-4 md:mb-6">
              Ihr <strong>Dachdecker-Meisterbetrieb</strong> – Spezialist für Altbausanierung und Dachgeschossausbau in <strong>{stadtteilData.name}</strong>.
            </p>
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-8">
              <div>
                <h2 className="text-2xl md:text-3xl font-heading font-bold text-secondary mb-4">089Dach GmbH – Ihr <strong>Dachdecker</strong> für {stadtteilData.name}</h2>
                <p className="text-lg text-muted-foreground leading-relaxed mb-4"><TextWithKeywordLinks currentPath="/dachdecker-giesing">{stadtteilData.beschreibung}</TextWithKeywordLinks></p>
                <p className="text-lg text-muted-foreground leading-relaxed">
                  Als <strong>Meisterbetrieb</strong> kennen wir die besonderen Anforderungen in <strong>Giesing</strong>. Ob <strong>Dachsanierung</strong>, <strong>Dachreparatur</strong> oder <strong>Notdienst</strong> – wir sind Ihr zuverlässiger <strong>Dachdecker</strong> in <strong>München</strong> Süd.
                </p>
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {[
                    { title: "Dachrinnenreinigung", desc: "Professionelle Rinnenreinigung in Giesing", img: imgDachrinnenreinigung },
            ...
            <div className="space-y-6">
              <div className="bg-primary text-white rounded-xl p-4 md:p-6">
                ...
                <p className="text-white/90 mb-6">Wir beraten Sie vor Ort – auch bei Dachgeschossausbau-Projekten.</p>
