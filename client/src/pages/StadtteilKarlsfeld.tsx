...
const stadtteilData = {
  name: "Karlsfeld",
  fullName: "Karlsfeld bei München",
  plz: "85757",
  entfernung: "8 km",
  beschreibung: "Karlsfeld ist eine der am schnellsten wachsenden Gemeinden im Münchner Norden. Die Mischung aus Neubaugebieten, etablierten Wohnsiedlungen und Gewerbeimmobilien bietet vielfältige Dachprojekte. Als Meisterbetrieb aus dem benachbarten München sind wir schnell vor Ort.",
  besonderheiten: [
    "Wachsende Gemeinde mit vielen Neubauten",
    "Etablierte Wohnsiedlungen aus den 1970-80ern",
    "Gute Erreichbarkeit vom Münchner Norden",
    "Mix aus Wohn- und Gewerbeimmobilien"
  ],
  typischeProjekte: [
    "Dachsanierung Bestandsimmobilie",
    "Flachdach-Abdichtung Gewerbe",
...
export default function StadtteilKarlsfeld() {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-secondary/5 rounded-xl p-4 md:p-6">
                ...
                <p className="text-muted-foreground mb-2"><TextWithKeywordLinks currentPath="/dachdecker-karlsfeld">{stadtteilData.referenzProjekt.beschreibung}</TextWithKeywordLinks></p>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gray-50 rounded-xl p-4 md:p-6">
                ...
                <ul className="space-y-3">
                  {["Meisterbetrieb seit 1998", "Schnelle Anfahrt", "10 Jahre Garantie", "KfW-Beratung", "Über 200 Projekte"].map((item, idx) => (
