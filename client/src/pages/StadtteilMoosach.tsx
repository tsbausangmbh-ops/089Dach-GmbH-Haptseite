...
const stadtteilData = {
  ...
  entfernung: "4 km",
  beschreibung: "Moosach liegt direkt neben unserem Standort in Obermenzing – wir sind in wenigen Minuten bei Ihnen! Das traditionelle Münchner Viertel vereint Altbauten mit modernen Wohnanlagen. Hier bieten wir besonders schnelle Reaktionszeiten und kennen die lokalen Gegebenheiten genau.",
  besonderheiten: [
    "Direkter Nachbarstadtteil – kürzeste Anfahrt",
    "Mischung aus Altbau und Neubau",
    "Viele Flachdächer bei Gewerbeimmobilien",
    "Gute Erreichbarkeit für Notdienst"
  ],
  typischeProjekte: [
...
function NearbyServiceSchema() {
  const schema = {
    ...
    "description": `Schnelle Dachdeckerarbeiten in ${stadtteilData.fullName}. Ihr Nachbar-Dachdecker mit kürzester Anfahrt.`,
    "provider": {
...
export default function StadtteilMoosach() {
  ...
  return (
    <div className="min-h-screen bg-background font-sans">
      <SEO 
        title="Dachdecker Moosach – Sanierung, Reparatur & Notdienst"
        description="Ihr Dachdecker in Moosach: Dachsanierung, Reparatur, Flachdach, Spengler, Dachfenster. 24/7 Notdienst, Festpreis & 10 Jahre Garantie. Jetzt anrufen!"
        canonical="https://089dach.de/dachdecker-moosach"
        keywords="Dachdecker Moosach, Dachsanierung Moosach, Dachreparatur Moosach, Flachdach Moosach, Spengler Moosach, Dach Notdienst Moosach, Dachfenster Moosach"
      />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-secondary/5 rounded-xl p-4 md:p-6">
                ...
                <p className="text-muted-foreground mb-2"><TextWithKeywordLinks currentPath="/dachdecker-moosach">{stadtteilData.referenzProjekt.beschreibung}</TextWithKeywordLinks></p>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gray-50 rounded-xl p-4 md:p-6">
                ...
                <ul className="space-y-3">
                  {["Meisterbetrieb seit 1998", "Direkter Nachbar", "10 Jahre Garantie", "Schnellster Notdienst", "Über 200 Projekte"].map((item, idx) => (
      ...
      <LeadFunnel 
        ...
        description="Ihr Dachdecker für Moosach – Meisterbetrieb mit schneller Hilfe."
      />
      <Contact 
        title="Dachdecker in Moosach gesucht?"
        description="Wir sind Ihr lokaler Dachdecker-Meisterbetrieb in Moosach."
      />
      <Footer />
    </div>
  );
