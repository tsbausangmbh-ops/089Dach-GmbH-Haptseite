...
const stadtteilData = {
  name: "Oberföhring",
  slug: "oberfoehring",
  fullName: "München-Oberföhring",
  plz: "81925, 81927, 81929",
  entfernung: "12 km",
  beschreibung: "Oberföhring ist ein gehobenes Wohnviertel im Münchner Nordosten mit vielen Villen und Einfamilienhäusern. Die anspruchsvolle Bausubstanz erfordert erfahrene Dachdecker mit Qualitätsanspruch.",
  besonderheiten: [
    "Gehobenes Villenviertel",
    "Hochwertige Einfamilienhäuser",
    "Nähe zur Isar und Englischer Garten"
  ],
  typischeProjekte: [
    "Villen-Dachsanierung",
    "Schiefereindeckung",
...
function NearbyServiceSchema() {
  const schema = {
    ...
    "description": `Professionelle Dachdeckerarbeiten in ${stadtteilData.fullName}. Spezialist für Villen und gehobene Wohnhäuser.`,
    "provider": {
...
export default function StadtteilOberfoehring() {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-secondary/5 rounded-xl p-4 md:p-6">
                ...
                <p className="text-muted-foreground mb-2"><TextWithKeywordLinks currentPath="/dachdecker-oberfoehring">{stadtteilData.referenzProjekt.beschreibung}</TextWithKeywordLinks></p>
            ...
            <div className="space-y-6">
              <div className="bg-primary text-white rounded-xl p-4 md:p-6">
                ...
                <p className="text-white/90 mb-6">Persönliche Beratung für Ihr Villenprojekt.</p>
              ...
              <div className="bg-gray-50 rounded-xl p-4 md:p-6">
                ...
                <ul className="space-y-3">
                  {["Meisterbetrieb seit 1998", "Villen-Erfahrung", "10 Jahre Garantie", "Eigene Spenglerwerkstatt", "Premium-Materialien"].map((item, idx) => (
