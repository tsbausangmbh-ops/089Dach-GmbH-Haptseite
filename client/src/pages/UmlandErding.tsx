...
const stadtteilData = {
  name: "Erding",
  fullName: "Erding bei München",
  plz: "85435",
  entfernung: "35 km",
  beschreibung: "Erding, bekannt durch die Therme Erding und das Weißbräu, ist eine wachsende Kreisstadt östlich von München. Die historische Altstadt und die vielen Einfamilienhäuser in den Wohngebieten bieten vielfältige Dachprojekte – von der Sanierung bis zum Neubau.",
  besonderheiten: [
    "Wachsende Kreisstadt im Osten",
    "Historische Altstadt",
    "Viele Einfamilienhäuser",
    "Nähe zur Therme Erding"
  ],
  typischeProjekte: [
...
function NearbyServiceSchema() {
  const schema = {
    ...
    "serviceType": ["Dachsanierung", "Dachdämmung", "Dachfenster", "Altbau"]
  };
  return (<script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(schema) }} />);
}

export default function UmlandErding() {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-8">
              <div>
                ...
                <p className="text-lg text-muted-foreground leading-relaxed">
                  Als Münchner Meisterbetrieb sind wir regelmäßig in Erding tätig und bieten die gleiche Qualität wie in München.
                </p>
              </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gray-50 rounded-xl p-4 md:p-6">
                ...
                <ul className="space-y-3">
                  {["Meisterbetrieb seit 1998", "Regelmäßig in Erding", "10 Jahre Garantie", "Festpreisgarantie", "Über 200 Projekte"].map((item, idx) => (
