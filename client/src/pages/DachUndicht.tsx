...
export default function DachUndicht() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="pt-6 pb-8 md:pt-10 md:pb-12 bg-red-900 relative overflow-hidden min-h-[40vh] flex items-center">
        <div className="absolute inset-0 bg-gradient-to-r from-red-900 via-red-800 to-red-700"></div>
